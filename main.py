...
# =========================================================================
router_map = APIRouter(prefix="/api/v1")

# Resource-based routers
router_map.include_router(skill_router)
router_map.include_router(version_router)
router_map.include_router(action_router)
router_map.include_router(connector_router)
router_map.include_router(category_router)
router_map.include_router(capability_router)
router_map.include_router(engine_router)

# Mount parent router to application
application.include_router(router_map)
